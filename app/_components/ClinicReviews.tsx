...
const ClinicReviews = () => {
  ...
  return (
    <div className='container lg:max-w-4xl 2xl:max-w-7xl py-8'>
      <h3 className='text-secondary font-bold text-lg lg:text-xl pb-4'>Patient Reviews</h3>
      <div className="relative">
        <div ref={scrollRef} className="flex overflow-x-scroll pb-10 hide-scroll-bar">
          <div className='flex flex-nowrap lg:gap-6 '> {/* This div remains unchanged */}
            {reviews.map((review, index) => (
              <div key={index} className='bg-white m-2 p-4 text-center w-[270px] h-[390px] rounded-xl'>
                <Image
                  src={review.image}
                  width={133}
                  height={133}
