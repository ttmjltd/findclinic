...
const Navbar: React.FC = () => {
  return (
    <nav className="block w-auto max-w-screen-xxl my-6 py-3 mx-6 xl:mx-20 text-primary lg:bg-white lg:rounded-xl  lg:backdrop-blur-xl lg:backdrop-saturate-200">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-1 md:gap-20">
          ...
          <Image
            src="/small-logo.png"
            alt="company logo" width={84} height={25}
  ...
  <Link href="/register-clinic">
    <button
      className="block sm:block px-2 py-1 sm:px-4 sm:py-2 mx-2 ml-6 font-inter font-semibold bg-accent text-white text-sm sm:text-lg rounded-lg focus:outline-none focus:shadow-outline bg-gradient-to-b hover:from-[#ADE8F4] hover:to-[#2A9D8F] transition-colors whitespace-nowrap"
      type="button"
    >
